...
public class MemberDAO {
	...
	// 비밀번호 변경
	public int changePw(Connection conn, String currentPw, String newPw, String newPwConfirm, Member loginMember) throws Exception {
		int result = 0;
	...
	// info
	public int info(Connection conn, Member loginMember, String memberNickname, String memberTel) throws Exception { 
		int result = 0;
	...
	public int secession(Connection conn, String memberPw) throws Exception {
		int result = 0;
