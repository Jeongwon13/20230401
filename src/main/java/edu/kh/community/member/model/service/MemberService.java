...
public class MemberService {
	...
	// 비밀번호 변경
	public int changePw(String currentPw, String newPw, String newPwConfirm, Member loginMember) throws Exception {
		Connection conn = getConnection();
		
		int result = dao.changePw(conn, currentPw, newPw, newPwConfirm, loginMember);
	...
	// 내 정보
	public int info(Member loginMember, String memberNickname, String memberTel) throws Exception {
		
		Connection conn = getConnection();
		
		int result = dao.info(conn, loginMember, memberNickname, memberTel);
	...
	// 회원 탈퇴
	public int secession(String memberPw) throws Exception {
		Connection conn = getConnection();
		
		int result = dao.secession(conn, memberPw);
